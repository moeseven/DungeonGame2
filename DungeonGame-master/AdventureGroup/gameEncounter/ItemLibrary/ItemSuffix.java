...
public class ItemSuffix extends Item_new{
	...
	public ItemSuffix(double power, String weight, String goldValue, String category, String droppable,
			String critChance, String critDamage, String attack, String block, String spell, String accuracy,
			String dodge, String speed, String draw, String mana, String thorns, String armor, String health,
			...
			String itemClass, String imageNumber,String turnBlock, String bonusExp,String name) {
		super(power, weight, goldValue, category, droppable, critChance, critDamage, attack, block, spell, accuracy, dodge,
				...
				stunChance, itemClass, imageNumber,turnBlock, bonusExp,name);
